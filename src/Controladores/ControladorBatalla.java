...
public class ControladorBatalla implements ActionListener {
    ...
    JefeDeTerreno[] jefes = new JefeDeTerreno[3];
    PuzleDeDados[] puzles = new PuzleDeDados[3];
    ...
    public void iniciar_Jugadores(String jugador1,String jugador2, String jugador3,String jugador4) throws SQLException{
        ...
        if(jugador3 != null){
            ...
            carasD2J3[0] = carasDadosJ2[1][0];
            carasD2J3[1] = carasDadosJ2[1][1];
            carasD2J3[2] = carasDadosJ2[1][2];
            carasD2J3[3] = carasDadosJ2[1][3];
            carasD2J3[4] = carasDadosJ2[1][4];
            carasD2J3[5] = carasDadosJ2[1][5];         
